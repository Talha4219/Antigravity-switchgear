        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="pt-6 space-y-4">
              <a
                href="https://www.google.com/maps/search/?api=1&query=Evergreen+Switchgear+Plot+56+Street+13+I-9/2+Islamabad"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-start gap-4 text-gray-400 group hover:text-white transition-colors w-fit"
              >
                <div className="bg-white/5 p-2 rounded-lg group-hover:bg-primary/20 transition-colors">
                  <MapPin size={18} className="text-primary" />
                </div>
                <span className="text-sm leading-6 group-hover:text-primary transition-colors">Plot # 56, Street # 13, I-9/2,<br />Islamabad, Pakistan</span>
              </a>

              <a
                href="mailto:admin@egswitchgear.com"
                className="flex items-center gap-4 text-gray-400 group hover:text-white transition-colors w-fit"
              >
                <div className="bg-white/5 p-2 rounded-lg group-hover:bg-primary/20 transition-colors">
                  <Mail size={18} className="text-primary" />
                </div>
                <span className="text-sm group-hover:text-primary transition-colors">admin@egswitchgear.com</span>
              </a>

              <a
                href="tel:+92514864909"
                className="flex items-center gap-4 text-gray-400 group hover:text-white transition-colors w-fit"
              >
                <div className="bg-white/5 p-2 rounded-lg group-hover:bg-primary/20 transition-colors">
                  <Phone size={18} className="text-primary" />
                </div>
                <span className="text-sm group-hover:text-primary transition-colors">+92 51 4864909</span>
              </a>

              <a
                href="tel:+92514864908"
                className="flex items-center gap-4 text-gray-400 group hover:text-white transition-colors w-fit"
              >
                <div className="bg-white/5 p-2 rounded-lg group-hover:bg-primary/20 transition-colors">
                  <Printer size={18} className="text-primary" />
                </div>
                <span className="text-sm group-hover:text-primary transition-colors">Fax: +92 51 4864908</span>
              </a>

              <a
                href="https://wa.me/923219574003"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 text-gray-400 group hover:text-white transition-colors w-fit"
              >
                ...
                <span className="text-sm group-hover:text-primary transition-colors">WhatsApp: +92 321 9574003</span>
              </a>
            </div>
          </div>
