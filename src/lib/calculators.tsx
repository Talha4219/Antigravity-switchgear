...
export const calculatorData: CalculatorInfo[] = [
    ...
    },
    {
        ...
        icon: Ruler,
        formula: <code>Cross Section = I / (J * k)</code>,
    ...
    },
    {
        ...
        title: 'PFI Plant Capacity Calculator',
        description: <p>Advanced <strong>capacitor bank calculator</strong> for <strong>PFI electrical</strong> systems. Optimize power factor and reduce energy costs with precise <strong>switchgear rating calculations</strong> for power factor correction panels.</p>,
        icon: Gauge,
        formula: <code>kVAR = kW * (tan&phi;1 - tan&phi;2)</code>,
        component: PowerFactorCorrectionCalculator,
        category: 'System Analysis',
    },
]
